        ...
        <div className='terms'>
           <div className='term1'> <ul>
            ...
            <ol>
                ...
                <ul>
                    <li>By accessing or using [Your Inventory Management Software] (the "Software"), you agree to abide by these Terms and Conditions. If you do not agree with these terms, please refrain from using the Software.</li>
                </ul>
                <li><strong>License</strong></li>
                <ul>
                    <li> [Your Company Name] grants you a limited, non-exclusive, non-transferable license to use the Software for its intended purpose, subject to these Terms and Conditions.</li>
                ...
                <ul>
                    <li>Your use of the Software is also governed by our Privacy Policy, which can be found at [Link to Privacy Policy]. By using the Software, you consent to the practices described in the Privacy Policy.</li>
                </ul>
                ...
                <ul>
                    <li>. [Your Company Name] retains all rights, title, and interest in and to the Software, including all intellectual property rights.</li>
                </ul>
                ...
                <ul>
                    <li> [Your Company Name] reserves the right to suspend or terminate your access to the Software at its discretion, with or without notice, if you violate these Terms and Conditions.</li>
                </ul>
                <li><strong>Limitation of Liability</strong></li>
                <ul><li>. To the extent permitted by law, [Your Company Name] shall not be liable for any direct, indirect, incidental, special, or consequential damages arising out of or in any way connected with the use of the Software.</li></ul>
                <li>Changes to Terms and Conditions</li>
                <ul>
                    <li> [Your Company Name] reserves the right to modify or revise these Terms and Conditions at any time. Continued use of the Software after such modifications shall constitute your consent to the changes.</li>
                </ul>
                ...
                <ul>
                  <li>If you have any questions or concerns about these Terms and Conditions, please contact us at [Your Contact Email].</li>
                  <li>By using [Your Inventory Management Software], you acknowledge that you have read, understood, and agreed to these Terms and Conditions.</li>
                </ul>
            </ol>
            </div>
        </div>
