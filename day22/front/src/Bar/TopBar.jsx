  ...
  return (
    <div className="topbar d-flex-r">
      <div className='topicon'><LocalGroceryStoreIcon style={{fontSize:'40px'}} /></div>
        ...
        <input type='text' placeholder='Type for Search' className='topsearch' style={{marginLeft:'70px',width:'15vw',height:'5vh',borderRadius:'5px',border:'none'}} onChange={(e)=>setSearchvalue(e.target.value)}></input>
        <div className='topsicon'><SearchIcon style={{fontSize:'25px'}}/></div>
        <div className='toprev' onClick={()=>navigate('/viewreview')}><Button style={{color:'black'}}><RateReviewIcon style={{fontSize:'40px'}}/></Button></div>
